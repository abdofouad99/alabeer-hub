...
function buildAgentInputData(array $data): array
{
    ...
    return [
        ...
        'tiktok' => [
            ...
            'videos_analyzed' => (int)($scan['tiktok']['videos_analyzed'] ?? 0),
            ...
            'avg_video_duration' => (float)($scan['tiktok']['avg_video_duration'] ?? 0),
            'avg_caption_length' => (int)($scan['tiktok']['avg_caption_length'] ?? 0),
            'engagement_rate' => (float)($scan['tiktok']['engagement_rate'] ?? 0),
            'engagement_rate_by_views'     => (float)($scan['tiktok']['engagement_rate_by_views'] ?? 0),
            'engagement_rate_by_followers' => (float)($scan['tiktok']['engagement_rate_by_followers'] ?? 0),
            'posts_per_week'  => $scan['tiktok']['posts_per_week'] ?? 0,
            'last_post_days'  => $scan['tiktok']['last_post_days'] ?? null,
        ...
        'twitter' => [
            ...
            'full_name'   => $scan['twitter']['full_name'] ?? '',
            'followers'   => (int)($scan['twitter']['followers'] ?? 0),
            'following'   => (int)($scan['twitter']['following'] ?? 0),
            'posts_count' => (int)($scan['twitter']['posts_count'] ?? 0),
            'tweets_analyzed' => (int)($scan['twitter']['tweets_analyzed'] ?? 0),
            'location'    => $scan['twitter']['location'] ?? '',
            'bio'         => $scan['twitter']['bio'] ?? '',
            'is_verified' => (bool)($scan['twitter']['is_verified'] ?? false),
            'avg_likes'        => (float)($scan['twitter']['avg_likes'] ?? 0),
            'avg_retweets'     => (float)($scan['twitter']['avg_retweets'] ?? 0),
            'avg_replies'      => (float)($scan['twitter']['avg_replies'] ?? 0),
            'avg_quotes'       => (float)($scan['twitter']['avg_quotes'] ?? 0),
            'avg_views'        => (float)($scan['twitter']['avg_views'] ?? 0),
            'engagement_rate'  => (float)($scan['twitter']['engagement_rate'] ?? 0),
            'engagement_rate_by_views'     => (float)($scan['twitter']['engagement_rate_by_views'] ?? 0),
            'engagement_rate_by_followers' => (float)($scan['twitter']['engagement_rate_by_followers'] ?? 0),
            'posts_per_week'   => $scan['twitter']['posts_per_week'] ?? 0,
            'last_post_days'   => $scan['twitter']['last_post_days'] ?? null,
