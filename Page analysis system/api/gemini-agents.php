...
$rawData = [
    'business_info' => [
        ...
        'lead_objective' => 'مبيعات',
        'lead_audience'  => 'نساء 25-40',
        'lead_budget'    => '5000 ريال/شهر',
    ],
    'website' => [
        'url' => 'https://example.com',
        'ssl' => true, 'pixel' => true, 'ga' => true,
        'whatsapp' => false, 'cta' => true, 'og_tags' => true,
        'schema' => false,
        'pagespeed_mobile' => 23, 'pagespeed_desktop' => 45,
    ],
    'instagram' => [
        'username' => 'example', 'followers' => 15000,
        'posts_count' => 120, 'avg_likes' => 150,
        'avg_comments' => 12, 'avg_saves' => 30,
        'avg_video_views' => 2000, 'reels_count' => 45,
        'engagement_rate' => 1.28, 'posts_per_week' => 2,
        'bio' => 'متجر إلكتروني | تواصل واتساب',
        'content_types' => ['reels' => 45, 'posts' => 75],
        'top_hashtags' => ['#تسوق', '#عرض', '#متجر'],
        'top_post_comments' => [
            'total_comments' => 340, 'positive_pct' => 60,
            'negative_pct' => 15, 'questions_pct' => 25,
            'top_objections' => ['السعر مرتفع', 'ما وصل الطلب', 'لا يوجد مقاسات']
        ],
    ],
    // ... remaining 9 data sources
];

try {
    $result = runMultiAgentAnalysis($rawData, [
        'apiKey'    => 'YOUR_GEMINI_API_KEY',
        'maxRetries' => 2,
        'retryDelay' => 5,
        'logCallback' => function(string $msg) { echo $msg . "\n"; },
    ]);

    // $result now contains all 18 pages
